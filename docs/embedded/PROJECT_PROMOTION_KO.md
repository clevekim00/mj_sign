...
[SIGN_GEMMA_APP_DEMO_KO.md](../backend/SIGN_GEMMA_APP_DEMO_KO.md)에 정리했습니다.
영문 가이드는 [SIGN_GEMMA_APP_DEMO.md](../backend/SIGN_GEMMA_APP_DEMO.md)입니다.
...
| 플랫폼 | 사용 장면 | 샘플 위치 |
| --- | --- | --- |
| Android | 모바일 채팅, 검색, 민원 앱 | `sample/embedded/flutter_app/lib/samples/android_sample.dart` |
| iOS | iPhone 앱 내 접근성 입력 | `sample/embedded/flutter_app/lib/samples/ios_sample.dart` |
| iPad | 교육, 키오스크, 상담 데스크 | `sample/embedded/flutter_app/lib/samples/ipad_sample.dart` |
| Web | 브라우저 기반 상담/접수 서비스 | `sample/embedded/flutter_app/lib/samples/web_sample.dart` |
| Windows | 데스크톱 키오스크, 공공기관 창구 | `sample/embedded/flutter_app/lib/samples/windows_sample.dart` |
| macOS/OSX | 개발/시연/크리에이터 워크플로 | `sample/embedded/flutter_app/lib/samples/macos_sample.dart` |
| Linux | edge GPU workstation, 연구 장비 | `sample/embedded/flutter_app/lib/samples/linux_sample.dart` |
