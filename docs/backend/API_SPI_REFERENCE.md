...
- `sign/embedded/lib/src/slr_input_widget.dart`
- `sign/embedded/lib/src/sign_gemma_client.dart`
- `sign/embedded/lib/src/landmark_frame_source.dart`
...
- frame batch는 `sign/common/schema/landmark.proto`의 `LandmarkFrame`을 따라야 합니다.
...
- Schema: `sign/common/schema/landmark.proto`
...
- `sign/backend/bridge/src/main/java/com/mj/sign/InferenceGateway.java`
...
- `sign/backend/bridge/src/main/java/com/mj/sign/InferenceContext.java`
- `sign/backend/bridge/src/main/java/com/mj/sign/SignLanguageResolver.java`
- `sign/backend/bridge/src/main/java/com/mj/sign/SignLanguageProperties.java`
...
- `sign/backend/bridge/src/main/java/com/mj/sign/GpuServingClient.java`
...
- `sign/backend/bridge/src/main/java/com/mj/sign/QueueInferenceTransport.java`
...
- `sign/backend/bridge/src/main/java/com/mj/sign/QueueWorkerBackend.java`
...
- `sign/backend/bridge/src/main/java/com/mj/sign/SignSynthesisService.java`
- `sign/backend/bridge/src/main/java/com/mj/sign/SignSynthesisController.java`
- `sign/backend/bridge/src/main/java/com/mj/sign/SpeechToTextAdapter.java`
- `sign/backend/bridge/src/main/java/com/mj/sign/SignPlanner.java`
- `sign/backend/bridge/src/main/java/com/mj/sign/SignMotionGenerator.java`
- `sign/backend/bridge/src/main/java/com/mj/sign/SignSynthesisProvider.java`
- `sign/backend/bridge/src/main/resources/application-synthesis-http.properties`
