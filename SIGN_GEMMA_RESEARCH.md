...
- English/ASL profile registry in `sign_gemma_mock/profile_registry.py`.
- Profile-specific Keras/Gemma engine cache in `sign_gemma_mock/sign_gemma_model.py`.
- Profile-aware `/health` and `/ready` endpoints in `sign_gemma_mock/main.py`.
